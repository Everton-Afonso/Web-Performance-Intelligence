...
const messages: Record<Locale, Record<string, string>> = {
  "pt-BR": {
    ...
    "form.strategy.both": "Mobile + Desktop",
    ...
    "projects.name.placeholder": "Nome do projeto",
    "projects.view": "Ver sites",
    "monitoring.title": "Monitoramento",
    "monitoring.new": "Novo monitor",
    "monitoring.form.site": "Site",
    "monitoring.form.strategy": "Estratégia",
    "monitoring.form.interval": "Intervalo (horas)",
    "monitoring.form.submit": "Criar monitor",
    "monitoring.table.site": "Site",
    "monitoring.table.strategy": "Estratégia",
    "monitoring.table.interval": "Intervalo",
    "monitoring.table.lastRun": "Última execução",
    "monitoring.table.status": "Status",
    "monitoring.table.actions": "Ações",
    "monitoring.enabled": "Ativo",
    "monitoring.disabled": "Pausado",
    "monitoring.run": "Executar",
    ...
    "alerts.empty": "Nenhum alerta registrado.",
    "alerts.type.regression": "Regressão",
    "alerts.type.goal": "Meta não atingida",
    "alerts.table.type": "Tipo",
    "alerts.table.metric": "Métrica",
    "alerts.table.message": "Mensagem",
    "alerts.table.date": "Data",
    "alerts.table.actions": "Ações",
    "alerts.markRead": "Marcar lido",
    "goals.title": "Metas",
    "goals.empty": "Nenhuma meta definida.",
    "goals.form.metric": "Métrica",
    "goals.form.target": "Valor",
    "goals.form.operator": "Condição",
    "goals.operator.lte": "≤",
    "goals.operator.gte": "≥",
  ...
  "en-US": {
    ...
    "projects.view": "View sites",
    "monitoring.title": "Monitoring",
    "monitoring.new": "New monitor",
    "monitoring.form.site": "Site",
    "monitoring.form.strategy": "Strategy",
    "monitoring.form.interval": "Interval (hours)",
    "monitoring.form.submit": "Create monitor",
    "monitoring.table.site": "Site",
    "monitoring.table.strategy": "Strategy",
    "monitoring.table.interval": "Interval",
    "monitoring.table.lastRun": "Last run",
    "monitoring.table.status": "Status",
    "monitoring.table.actions": "Actions",
    "monitoring.enabled": "Active",
    "monitoring.disabled": "Paused",
    "monitoring.run": "Run now",
    ...
    "alerts.type.regression": "Regression",
    "alerts.type.goal": "Goal missed",
    ...
    "goals.form.target": "Value",
    "goals.form.operator": "Condition",
    "goals.operator.lte": "≤",
    "goals.operator.gte": "≥",
